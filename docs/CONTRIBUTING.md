# Contributing to Krishi Mitra

Thank you for your interest in contributing to Krishi Mitra!
...
```bash
git remote add upstream https://github.com/axion/krishi-mitra.git
```
...
Contact the maintainers or email support@krishi-mitra.com
